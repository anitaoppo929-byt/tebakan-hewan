...
menuClueButton.addEventListener('click', function(){
  menuClueBubble.innerText="💡 Tebak hewan berdasarkan gambar! Klik 'Mulai' untuk memulai permainan. Kamu akan mendapatkan koin jika menebak benar, dan bisa menggunakan petunjuk jika kesulitan.";
  menuClueBubble.classList.add("visible");
});
...
function loadLevel(){
  ...
  bubble.innerText=""; bubble.classList.remove("visible");
  updateLevelDisplay();
...
document.getElementById('clueBubble').addEventListener('click',function(){ this.classList.remove("visible"); });
